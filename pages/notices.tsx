        ...
        <div className="flex flex-col-reverse md:flex-row pb-0 md:pb-6 mt-44 md:mt-0 place-content-center items-center relative top-0 z-20">
          <div className="flex flex-col w-full md:w-1/2 place-content-center p-14 px-10 md:px-14">
            ...
            <p className="mt-2 text-center md:text-left" data-aos="fade-right">
              <span className="text-3xl font-semibold">B</span>eing
              the Faculty of Computing's main and governing student
              committee, the committee dedicates itself to providing the
              students with the necessary direction they need to carry out their
              academic and non-academic activities without much hassle or
              confusion. Their guidance includes the sharing of notices which
              extends to all aspects of studentship like semester registrations,
              exam procedures to name a few.
            </p>
          </div>
