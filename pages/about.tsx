  ...
  return (
    <div>
      ...
      <div className="justify-items-center">
        ...
        <div
          className="flex flex-col-reverse md:flex-row pb-0 md:pb-6 mt-44 md:mt-0 place-content-center items-center relative top-0 z-20">
          <div className="flex flex-col w-full md:w-1/2 place-content-center p-14 px-10 md:px-14">
            ...
            <p className="mt-2 text-center md:text-left lg:text-justify" data-aos="fade-right">
              <span className="text-3xl font-semibold">T</span>he Faculty of Computing Student Community also known as
              the FCSC is the largest student body of the Faculty of Computing. The Faculty of Computing Student
              Community was established under the Faculty of Computing and consists of Computing undergraduates.
            </p>
            <p className="mt-2 text-center md:text-left lg:text-justify" data-aos="fade-right">
              ...
              University experience. The following are some of the main events organized by our Student Community,
            </p>
          </div>
